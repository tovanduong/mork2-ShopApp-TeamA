...
export const fetchPostVerify = createAsyncThunk('users/postVerify', async (payload) => {
  const response = await postVerify(payload);
  return response;
});

export const fetchGetProductId = createAsyncThunk('users/getProductId', async (payload) => {
  const response = await getProductId(payload);
  return response;
});

export const fetchGetAllProduct = createAsyncThunk('users/getAllProduct', async (payload) => {
  const response = await getAllProduct(payload);
  return response;
});

export const fetchSearchProduct = createAsyncThunk('users/getSearchProduct', async (payload) => {
  const response = await getSearchProduct(payload);
  return response;
});

export const fetchCreateCart = createAsyncThunk('users/postCreateCart', async (payload) => {
  const response = await postCreateCart(payload);
  localStorage.setItem('createCartUser', JSON.stringify(response));
  return response;
});

export const fetchUpdateCart = createAsyncThunk('users/patchUpdateCart', async (payload) => {
...
export const fetchAddItemToCart = createAsyncThunk('users/postItemToCart', async (payload) => {
  const response = await postItemToCart(payload);
  return response;
});

export const fetchDelItem = createAsyncThunk('users/delItem', async (payload) => {
...
export const fetchOrder = createAsyncThunk('users/postCheckOut', async (payload) => {
  const response = await postOrder(payload);
  return response;
});

export const fetchGetOrder = createAsyncThunk('users/getRecentOrder', async (payload) => {
  const response = await getOrder(payload);
  return response;
});

export const fetchEditContact = createAsyncThunk('users/patchContact', async (payload) => {
  const response = await patchContact(payload);
  localStorage.setItem('user', JSON.stringify(response));
  return response;
});

export const fetchEditEmail = createAsyncThunk('users/patchEmail', async (payload) => {
  const response = await patchEmail(payload);
  localStorage.setItem('user', JSON.stringify(response));
  return response;
});

export const fetchGetListProductByCategory = createAsyncThunk(
  'users/getListProductByCategory',
  async (category) => {
    const response = await getListProductByCategory(category);
...
export const UserSlice = createSlice({
  ...
  extraReducers: {
    ...
    [fetchGetListProductByCategory.fulfilled]: (state, action) => {
      state.loading = true;
      state.listProductById = action.payload;
    },
  },
});
