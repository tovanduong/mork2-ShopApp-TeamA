...
const VerifyEmail = ({ onClose }) => {
    ...
    return (
        <Box className='Modal-Forgot' >
            <Box ml='47px' mr='auto'>
                <Typography variant="h4" mb='7px'>Verify Email</Typography>
                <Typography variant="subtitle1" fontSize='12px' mb='31px'>Please enter your token to verify email</Typography>
            </Box>
