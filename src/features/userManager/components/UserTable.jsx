...
import { deleteUserById, getAllUsers } from '../userManagerSlice';
...
export function UserTable(props) {
  ...
  //delete user by id
  const dispatchDelete = async (userId) => {
    try {
        ...
        return (
          ...
          >
            ...
            <IconButton
              ...
              onClick={(e) => handleClickOpen(params.row.userId)}
            >
