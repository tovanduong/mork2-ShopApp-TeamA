...
export function getProductId(id) {
  return axiosClient.get(GET_PRODUCT + id)
    .then(res => {
      return res.data
    })
    .catch(err => {
...
export function getSearchProduct(value) {
  return axiosClient.get(GET_SEARCH_PRODUCT + value)
    .then(res => {
      return res.data
    })
    .catch(err => {
...
export function postCreateCart({ cart, itemArr }) {
  return axiosClient.post(POST_CREATE_CART, {
    cart,
    itemArr
  })
    .then(res => {
...
export function patchUpdateCart({ quantity, total, id }) {
  return axiosClient.patch(PATCH_UPDATE_CART + id, {
    quantity,
    total
  })
    .then(res => {
...
export function getCartById({ id }) {
  return axiosClient.get(GET_CARD_BY_ID + id)
    .then(res => {
      return res.data
    })
    .catch(err => {
...
export function postItemToCart({ cartId, productId, quantity, price, total }) {
  return axiosClient.post(POST_CREATE_ITEM, {
    cartId,
    productId,
    quantity,
    price,
...
export function postOrder({ orderCreate, itemArr }) {
  return axiosClient.post(POST_ORDER, {
    order: orderCreate,
    itemArr,
  })
    .then(res => {
...
export function getOrder({ size, currentPage }) {
  return axiosClient.get(`${GET_ORDER}?size=${size}&page=${currentPage}`)
    .then(res => {
      return res.data
    })
    .catch(err => {
...
export function patchContact(contact) {
  return axiosClient.patch(PATCH_CONTACT, {
    contact: contact,
  })
    .then(res => {
...
export function patchEmail(email) {
  return axiosClient.patch(PATCH_EMAIL, {
    email: email,
  })
    .then(res => {
      toast.success('Update Success')
