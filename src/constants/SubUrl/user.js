...
export const GET_ALL_CATEGORY = '/v1/products/get-all-categories'
export const POST_ORDER = '/v1/orders'
export const GET_ORDER = '/v1/orders/my-orders/'

export const PATCH_CONTACT = '/v1/users/change-contact'
export const PATCH_EMAIL = '/v1/users/change-email'